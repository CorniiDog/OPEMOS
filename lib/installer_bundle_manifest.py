...
FILES = (
    ...
    ("lib/progress_semantics.py", "contract-adapter", "0755"),
    ("lib/generate_installer_progress_fixtures.py", "contract-fixture-generator", "0755"),
    ("lib/generate_progress_semantics_fixtures.py", "contract-fixture-generator", "0755"),
    ("lib/generate_result_semantics_fixtures.py", "contract-fixture-generator", "0755"),
    ...
    ("lib/generate_userspace_lock_bootstrap_fixtures.py", "contract-fixture-generator", "0755"),
    ("lib/generate_userspace_lock_request_plan_fixtures.py", "contract-fixture-generator", "0755"),
    ("lib/generate_userspace_lock_verifier_evidence_fixtures.py", "contract-fixture-generator", "0755"),
    ("lib/userspace_lock_bootstrap_contract.py", "contract-validator", "0755"),
    ("lib/userspace_lock_generation_contract.py", "contract-validator", "0755"),
    ("lib/userspace_lock_request_plan.py", "contract-validator", "0755"),
    ("lib/userspace_lock_verifier_evidence.py", "contract-validator", "0755"),
    ("lib/consume_appliance_generation.py", "installer-helper", "0755"),
    ("lib/generate_development_appliance_generation.py", "contract-fixture-generator", "0755"),
    ("lib/source_intent_contract.py", "contract-validator", "0755"),
    ("lib/generate_source_intent_fixtures.py", "contract-fixture-generator", "0755"),
    ...
    ("contracts/schemas/userspace-lock-discovery-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/userspace-lock-generation-manifest-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/userspace-lock-bootstrap-policy-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/userspace-lock-bootstrap-checkpoint-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/userspace-lock-generation-request-plan-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/userspace-lock-verifier-evidence-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/appliance-generation-handoff-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/source-intent-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/source-authorization-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/device-generation-result-v1.schema.json", "contract-schema", "0644"),
    ("contracts/schemas/device-generation-health-v1.schema.json", "contract-schema", "0644"),
    ("contracts/fixtures/resolver-compatibility-v2.json", "contract-fixture", "0644"),
    ("contracts/fixtures/progress-semantics-v1.json", "contract-fixture", "0644"),
    ("contracts/fixtures/result-semantics-v1.json", "contract-fixture", "0644"),
